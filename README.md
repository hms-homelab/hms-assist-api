...
**Test counts:** 112 C++ unit · 30 Python sync unit · 16 sync e2e · 23 API e2e = **181 total**
...
- **LLM:** llama3.2:3b (tier3a) + 120b cloud model (tier3b) via Ollama
